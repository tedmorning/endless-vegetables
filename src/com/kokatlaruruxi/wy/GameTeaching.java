...
//	private final int STATE_1 = 0;//文字提示
	...
	private Sprite teachIcon;
	
	private Sprite teachBg;
...
//	private Matrix matrix;
	...
	public static short TEACH_VOL45 = 44;//第7关结算界面后,小蓝怪教学
	...
	public static short TEACH_VOL49 = 48;//播下种子，可以种出随机的作物
	public static short TEACH_VOL50 = 49;//等待一会儿，就可以成熟收获了
	public static short TEACH_VOL51 = 50;//使用洒水壶可以加速作物生长哦！
	public static short TEACH_VOL52 = 51;//恭喜你可以收获一个宝箱
	public static short TEACH_VOL53 = 52;//打开你的宝箱，看看里面有什么
	public static short TEACH_VOL54 = 53;//种植中使用铲子，可以去除你不想要的作物哦
	public static short TEACH_VOL55 = 54;//下方可以购买工具哦
	public static short TEACH_VOL56 = 55;//使用“一键成熟”能使所有作物立即成熟
	...
	public static boolean teachingArrary[] = {
			...
			false,//47售卡教学
			false,//48售卡教学
			false,//49播下种子，可以种出随机的作物
			false,//50等待一会儿，就可以成熟收获了
			false,//51使用洒水壶可以加速作物生长哦！
			false,//52恭喜你可以收获一个宝箱
			false,//53打开你的宝箱，看看里面有什么
			false,//54种植中使用铲子，可以去除你不想要的作物哦
			false,//55下方可以购买工具哦
			false,//56使用“一键成熟”能使所有作物立即成熟
...
//		 ||state==STATE_1
	...
	{
		if(teachIcon==null)
			teachIcon = new Sprite(GameImage.getImage("teach/ui_guidance_01"));

		if(teachBg==null)
			teachBg = new Sprite(GameImage.getImage("teach/ui_guidance_02"));

		if(mask==null)
			mask = new Sprite(GameImage.getImage("teach/mask"));		

		if(hand==null)
			hand = new Sprite(GameImage.getImage("teach/hand"));		
	}
