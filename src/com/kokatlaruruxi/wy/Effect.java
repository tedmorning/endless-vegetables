...
public class Effect {
	...
	private ArrayList<Sprite> effect;
	...
	public void loadImage()
	{
		...
		smallGolden = new Sprite(GameImage.getImage("newEffect/glod_small_1"));
		
		bigGolden = new Sprite(GameImage.getImage("newEffect/glod_big"));
		
		box = new Sprite(GameImage.getImage("newEffect/Mini_2_bag1"));
...
//		SpriteLibrary.loadSpriteImage(CoolEditDefine.Effect_ICESTATELV1);
//		SpriteLibrary.loadSpriteImage(CoolEditDefine.Effect_ICESTATELV2);
		SpriteLibrary.loadSpriteImage(CoolEditDefine.Effect_ICESTATELV3);
		SpriteLibrary.loadSpriteImage(CoolEditDefine.Effect_DIZZINESS);
		SpriteLibrary.loadSpriteImage(CoolEditDefine.Effect_SLOWDOWN);
//		SpriteLibrary.loadSpriteImage(CoolEditDefine.Effect_EMPTYBOX);		
		SpriteLibrary.loadSpriteImage(CoolEditDefine.Effect_ATTACK2);
		SpriteLibrary.loadSpriteImage(CoolEditDefine.Effect_RESTORE);
		SpriteLibrary.loadSpriteImage(CoolEditDefine.Effect_GEM);
		SpriteLibrary.loadSpriteImage(CoolEditDefine.Effect_GOLDEN);		
		SpriteLibrary.loadSpriteImage(CoolEditDefine.SMALL_CARD_BOX);
		SpriteLibrary.loadSpriteImage(CoolEditDefine.SMALL_CARD);		
	}
...
//		SpriteLibrary.DelSpriteImage(CoolEditDefine.Effect_ICESTATELV1);
//		SpriteLibrary.DelSpriteImage(CoolEditDefine.Effect_ICESTATELV2);
		SpriteLibrary.DelSpriteImage(CoolEditDefine.Effect_ICESTATELV3);
		SpriteLibrary.DelSpriteImage(CoolEditDefine.Effect_DIZZINESS);
		SpriteLibrary.DelSpriteImage(CoolEditDefine.Effect_SLOWDOWN);
//		SpriteLibrary.DelSpriteImage(CoolEditDefine.Effect_EMPTYBOX);
		SpriteLibrary.DelSpriteImage(CoolEditDefine.Effect_ATTACK2);
		SpriteLibrary.DelSpriteImage(CoolEditDefine.Effect_RESTORE);
		SpriteLibrary.DelSpriteImage(CoolEditDefine.Effect_GEM);
		SpriteLibrary.DelSpriteImage(CoolEditDefine.Effect_GOLDEN);
		SpriteLibrary.DelSpriteImage(CoolEditDefine.SMALL_CARD_BOX);
		SpriteLibrary.DelSpriteImage(CoolEditDefine.SMALL_CARD);
	...
	public void add(Sprite enemy, int kind,int x,int y,int state,int showTime)
	{
		effectLinkNumber ++;
...
//		if(effect.get(i).kind==SpriteLibrary.Effect_ICEATTACK)
//		{
//			if(effect.get(i).state == Sprite.SPRITE_STATE_NONE)
//			{
//				add(SpriteLibrary.Effect_ICESTATE, (int)effect.get(i).x, (int)effect.get(i).y, Sprite.SPRITE_STATE_NORMAL, effect.get(i).effectShowTime);
//			}				
//		}
//		else if(effect.get(i).kind==SpriteLibrary.Effect_ICESTATE)
//		{				
//			if(effect.get(i).effectShowTime>0)
//			{
//				effect.get(i).effectShowTime--;
...
//	{
//		if(effect.get(i).kind==SpriteLibrary.Effect_SUMMON)
//		{				
//			if(effect.get(i).effectShowTime>0)
//			{
//				effect.get(i).effectShowTime--;
//				
//				if(effect.get(i).effectShowTime==0)
//				   effect.get(i).setState(Sprite.SPRITE_STATE_NONE);
//			}				
//		}
//	}
...
//	{
//		if(effect.get(i).kind==SpriteLibrary.Effect_SHIELD)
//		{				
//			if(effect.get(i).effectShowTime>0)
//			{
//				effect.get(i).effectShowTime --;
	...
	class Manually
	{
		...
		{						
			...
			{	
				...
				{
//					add(CoolEditDefine.Effect_EMPTYBOX, jumpX+jumpXOffset, jumpY+box.bitmap.getHeight()/2, Sprite.SPRITE_STATE_NORMAL, 0, 1f);
...
//				light.drawBitmap(canvas, light.bitmap, matrix, paint);
		...
		private void jump(Canvas canvas, Sprite bm)
		{
			Paint paint = new Paint();
