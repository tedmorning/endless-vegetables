...
public class TurnGameSpriteLattice {

	private TurnGameSprite spriteLattice;
	...
	public TurnGameSprite getSpriteLattice()
	{
	...
	{
		return TurnGameSpriteLibrary.GetH(spriteLattice.kind);
	}
	...
	public void initSpriteLattice(int lifeValue, int x, int y, int level)
	{
		...
		TurnGameSpriteLibrary.loadSpriteImage(spriteLatticeKind);
		
		spriteLattice = new TurnGameSprite();
		spriteLattice.setSize(2);
		spriteLattice.initSprite(spriteLatticeKind, x, y, TurnGameSprite.SPRITE_STATE_NORMAL);
		//spriteLattice
		spriteLattice.setXY(x, y-TurnGameSpriteLibrary.GetH(spriteLattice.kind)/2);
	...
	{
		TurnGameSpriteLibrary.DelSpriteImage(spriteLatticeKind);
...
//	
	...
	public void spriteLatticeLostBlood(TurnGameSprite sprite)
	{
		if(spriteLattice.life>0)
		{
			spriteLattice.life -= TurnGameSpriteLibrary.GetAttack(sprite.kind);							
