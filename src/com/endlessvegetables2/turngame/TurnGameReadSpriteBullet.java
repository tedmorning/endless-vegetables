...
public class TurnGameReadSpriteBullet {

	private TurnGameSprite spriteBullet;
...
//	private Effect effect;
	...
	public TurnGameReadSpriteBullet()
	{
//		effect = new Effect();
//		
//		effect.add(SpriteLibrary.Effect_HALO, 0, 0, Sprite.SPRITE_STATE_NORMAL, 0);		
	...
	{
		spriteBullet = new TurnGameSprite();
				
		spriteBullet.initSprite(playerId, x, y, TurnGameSprite.SPRITE_STATE_NORMAL);
...
//		GameMedia.playSound(R.raw.yx006, 0);
	...
	{
		spriteBullet.state = TurnGameSprite.SPRITE_STATE_NONE;
	}
...
//		effect.updata();
	...
	{
		if(spriteBullet!=null && spriteBullet.state!=TurnGameSprite.SPRITE_STATE_NONE)
		{
	...
	public TurnGameSprite getSpriteBullet()
	{
		return spriteBullet;
	}
