...
public class TurnGameReadData {
//
//	public static int bombLevel;
//	
	public void stageNumber(TurnGameMain gameMain)
	{
		gameMain.stageIndex = VeggiesData.getCurrentLevel();
	}
	
	public void setLeftPlayerID(TurnGameMain gameMain)
	{
	...
	public void setRightPlayerID(TurnGameMain gameMain)
	{
		int slot = 0;
	...
	public void setGameUITool(TurnGameMain gameMain)
	{		 		                                    
		slot = new byte[2];
...
//						bombLevel = 3;
			...
			else
			{
				//没有道具
				slot_Item_id[i] = VeggiesData.getCardSlot()[i+5];
				slot[i] = TurnGameUI.ITEM_TYPE_0;
				slot_level[i] = 1;								
			}
		}
		
		gameMain.gameUI.initGameUITool(new byte[]{slot[0], slot[1], (gameMain.stageIndex<4?TurnGameUI.ITEM_TYPE_0:TurnGameUI.ITEM_TYPE_5)},
	...
	public void setLatticeLife(TurnGameMain gameMain)
	{
		gameMain.latticeLife = VeggiesData.getFence_HP();
		
		gameMain.latticeLife = (int)(gameMain.latticeLife*TurnGamePowerCard.latticeBlood);
	}
	...
	public void setGemNumber(TurnGameMain gameMain)
	{
		gameMain.gemNumber = VeggiesData.getGem();
	}
	
	public void setGoldNumber(TurnGameMain gameMain)
	{
		gameMain.goldenNumber = VeggiesData.getGold();				
	}
	
	public void setComboShowTime(TurnGameMain gameMain)
	{
	...
	{
		TurnGamePowerCard.setPowerCard(VeggiesData.getCardSlot()[4]);
	}
	
	public void setSlingShotLevel(TurnGameMain gameMain)
	{		
