...
//	private Sprite[] shop_lv; //显示质量的
	...
	public static final boolean[] shopUpbox = //商店升级金币宝石图标
	{//true为金币,flase为宝石
		true,true,
		false,false,
	};
...
//		GameImage.delImageArray(price_num);
	...
	public void Release() {
		...
		for(int i=0;i<shopIcon.length;++i){
			if(shopIcon[i].bitmap!=null)
				GameImage.delImage(shopIcon[i].bitmap);
			shopIcon[i].bitmap=null;
			shopIcon[i] = null;
		}
		shopIcon = null;
...
//		}
		...
		shopIcon = new Sprite[6];
		shopIcon[0] = new Sprite(GameImage.getImage(GameStaticImage.shop_box1));
		shopIcon[1] = new Sprite(GameImage.getImage(GameStaticImage.shop_box2));
		shopIcon[2] = new Sprite(GameImage.getImage(GameStaticImage.shop_card1));
		shopIcon[3] = new Sprite(GameImage.getImage(GameStaticImage.shop_card2));
		shopIcon[4] = new Sprite(GameImage.getImage(GameStaticImage.shop_king));
		shopIcon[5] = new Sprite(GameImage.getImage(GameStaticImage.shop_xing));
...
//		price_num = GameImage.getAutoSizecutBitmap(GameStaticImage.word_num_04, 12, 1, GameImage.Sort_line);
		...
		for (int i=0; i<shopitemword.length; i++) {
			...
			shopitemword[i].setTextSize((int)(30*GameConfig.f_zoom));
...
//		if (isHideShop) return;
		if(shop_index != 0){
			...
			GameStaticImage.s_share_ui_back_01.drawBitmap(canvas, null, (int)(28 * GameConfig.f_zoomx), (int)(84 * GameConfig.f_zoomy), (int)(476 * GameConfig.f_zoomx), (int)(700 * GameConfig.f_zoomy), -1);
			GameStaticImage.s_share_ui_back_02.drawBitmap(canvas, null, (int)(45 * GameConfig.f_zoomx), (int)(170 * GameConfig.f_zoomy), (int)(442 * GameConfig.f_zoomx), (int)(177 * GameConfig.f_zoomy), -1);
			GameStaticImage.s_share_ui_back_02_2.drawBitmap(canvas, null, (int)(45 * GameConfig.f_zoomx), (int)(170 * GameConfig.f_zoomy), (int)(442 * GameConfig.f_zoomx), (int)(177 * GameConfig.f_zoomy), -1);
//			GameStaticImage.s_share_ui_back_03.drawBitmap(canvas, null, (int)((45+10) * GameConfig.f_zoomx), (int)((170+10) * GameConfig.f_zoomy), (int)((442-20) * GameConfig.f_zoomx), (int)((177-20) * GameConfig.f_zoomy), -1);
			
			paint.setAntiAlias(true);                       //设置画笔为无锯齿     
			paint.setStrokeWidth((float) 3.0);              //线宽      
			paint.setColor(Color.argb(255, 248, 220, 86));                    //设置画笔颜色      
			RectF r2=new RectF();
			r2.left=(int) (54 * GameConfig.f_zoomx);                                 //左边      
			r2.top=(int) (181 * GameConfig.f_zoomy);                                 //上边      
			r2.right=(int) ((54+425) * GameConfig.f_zoomx);                                   //右边     
			r2.bottom=(int) ((181+158) * GameConfig.f_zoomy);      
			canvas.drawRoundRect(r2, 40, 40, paint);        //绘制圆角矩形  
			shopIcon[5].drawBitmap(canvas, null, (int)(202 * GameConfig.f_zoomx), (int)(181 * GameConfig.f_zoomy), (int)(275 * GameConfig.f_zoomx ), -1);
		 	
			
			GameStaticImage.s_share_ui_back_02.drawBitmap(canvas, null, (int)(45 * GameConfig.f_zoomx), (int)(359 * GameConfig.f_zoomy), (int)(442 * GameConfig.f_zoomx), (int)(177 * GameConfig.f_zoomy), -1);
			GameStaticImage.s_share_ui_back_02_2.drawBitmap(canvas, null, (int)(45 * GameConfig.f_zoomx), (int)(359 * GameConfig.f_zoomy), (int)(442 * GameConfig.f_zoomx), (int)(177 * GameConfig.f_zoomy), -1);
//			GameStaticImage.s_share_ui_back_03.drawBitmap(canvas, null, (int)((45+10) * GameConfig.f_zoomx), (int)((159+10) * GameConfig.f_zoomy), (int)((442-20) * GameConfig.f_zoomx), (int)((177-20) * GameConfig.f_zoomy), -1);
			r2=new RectF();
			r2.left=(int) (54 * GameConfig.f_zoomx);                                 //左边      
			r2.top=(int) (369 * GameConfig.f_zoomy);                                 //上边      
			r2.right=(int) ((54+425) * GameConfig.f_zoomx);                                   //右边     
			r2.bottom=(int) ((369+158) * GameConfig.f_zoomy);      
			canvas.drawRoundRect(r2, 40, 40, paint);        //绘制圆角矩形  
			shopIcon[5].drawBitmap(canvas, null, (int)(202 * GameConfig.f_zoomx), (int)(369 * GameConfig.f_zoomy), (int)(275 * GameConfig.f_zoomx ), -1);
		 	
			
			GameStaticImage.s_share_ui_back_02.drawBitmap(canvas, null, (int)(62 * GameConfig.f_zoomx), (int)(553 * GameConfig.f_zoomy), (int)(195 * GameConfig.f_zoomx), (int)(194 * GameConfig.f_zoomy), -1);
			GameStaticImage.s_share_ui_back_02_2.drawBitmap(canvas, null, (int)(62 * GameConfig.f_zoomx), (int)(553 * GameConfig.f_zoomy), (int)(195 * GameConfig.f_zoomx), (int)(194 * GameConfig.f_zoomy), -1);
//			GameStaticImage.s_share_ui_back_03.drawBitmap(canvas, null, (int)((62+10) * GameConfig.f_zoomx), (int)((553+10) * GameConfig.f_zoomy), (int)((195-20) * GameConfig.f_zoomx), (int)((194-20) * GameConfig.f_zoomy), -1);
			r2=new RectF();
			r2.left=(int) (74 * GameConfig.f_zoomx);                                 //左边      
			r2.top=(int) (565 * GameConfig.f_zoomy);                                 //上边      
			r2.right=(int) ((74+170) * GameConfig.f_zoomx);                                   //右边     
			r2.bottom=(int) ((565+172) * GameConfig.f_zoomy);      
			canvas.drawRoundRect(r2, 40, 40, paint);        //绘制圆角矩形
			
			
			GameStaticImage.s_share_ui_back_02.drawBitmap(canvas, null, (int)(273 * GameConfig.f_zoomx), (int)(553 * GameConfig.f_zoomy), (int)(195 * GameConfig.f_zoomx), (int)(194 * GameConfig.f_zoomy), -1);
			GameStaticImage.s_share_ui_back_02_2.drawBitmap(canvas, null, (int)(273 * GameConfig.f_zoomx), (int)(553 * GameConfig.f_zoomy), (int)(195 * GameConfig.f_zoomx), (int)(194 * GameConfig.f_zoomy), -1);
//			GameStaticImage.s_share_ui_back_03.drawBitmap(canvas, null, (int)((273+10) * GameConfig.f_zoomx), (int)((553+10) * GameConfig.f_zoomy), (int)((195-20) * GameConfig.f_zoomx), (int)((194-20) * GameConfig.f_zoomy), -1);
			r2=new RectF();
			r2.left=(int) (285 * GameConfig.f_zoomx);                                 //左边      
			r2.top=(int) (565 * GameConfig.f_zoomy);                                 //上边      
			r2.right=(int) ((285+170) * GameConfig.f_zoomx);                                   //右边     
			r2.bottom=(int) ((565+172) * GameConfig.f_zoomy);      
			canvas.drawRoundRect(r2, 40, 40, paint);        //绘制圆角矩形
...
//						GameStaticImage.s_share_ui_button_03.drawBitmap(canvas, (int)(Location.GameShop.shopbutton_xy[i][0] * GameConfig.f_zoomx) - GameStaticImage.s_share_ui_button_03.bitmap.getWidth()/2*(anjianbutton[i]?0.2f:0f), (int)(Location.GameShop.shopbutton_xy[i][1] * GameConfig.f_zoomy) - GameStaticImage.s_share_ui_button_03.bitmap.getHeight()/2*(anjianbutton[i]?0.2f:0f), anjianbutton[i]?1.2f:1f, anjianbutton[i]?1.2f:1f, 255, 0, 0, 0);
						if (anjianbutton[i]) {
							GameStaticImage.s_share_ui_button_03.drawBitmap(canvas, null, (int)(Location.GameShop.shopbutton_xy[i][0] * GameConfig.f_zoomx + (GameStaticImage.s_share_ui_button_01[0].bitmap.getWidth()/2 - GameStaticImage.s_share_ui_button_01[1].bitmap.getWidth()/2)), (int)(Location.GameShop.shopbutton_xy[i][1] * GameConfig.f_zoomy  + (GameStaticImage.s_share_ui_button_03.bitmap.getHeight()/2 - GameStaticImage.s_share_ui_button_03.bitmap.getHeight()/2)), (int)(134 * GameConfig.f_zoomx * 1.2f), -1);
					 	} else {				
							GameStaticImage.s_share_ui_button_03.drawBitmap(canvas, null, (int)(Location.GameShop.shopbutton_xy[i][0] * GameConfig.f_zoomx), (int)(Location.GameShop.shopbutton_xy[i][1] * GameConfig.f_zoomy), (int)(134 * GameConfig.f_zoomx), -1);
						}
					
					if(i == 1){
//						shopIcon[4].drawBitmap(canvas, null, (int)(202 * GameConfig.f_zoomx), (int)(181 * GameConfig.f_zoomy), (int)(275 * GameConfig.f_zoomx ), -1);
						shopIcon[4].drawBitmap(canvas, (int)(398 * GameConfig.f_zoomx) -  shopIcon[4].bitmap.getWidth()/2*(anjianbutton[i]?0.2f:0f), (int)(440 * GameConfig.f_zoomy) - shopIcon[4].bitmap.getHeight()/2*(anjianbutton[i]?0.2f:0f), anjianbutton[i]?1.2f:1f, anjianbutton[i]?1.2f:1f, 255, 0, 0, 0);
					}
					
				}else
					if (anjianbutton[i]) {
						GameStaticImage.s_share_ui_button_01[1].drawBitmap(canvas, null, (int)(Location.GameShop.shopUpGradebutton_xy[i][0] * GameConfig.f_zoomx + (GameStaticImage.s_share_ui_button_01[0].bitmap.getWidth()/2 - GameStaticImage.s_share_ui_button_01[1].bitmap.getWidth()/2)), (int)(Location.GameShop.shopUpGradebutton_xy[i][1] * GameConfig.f_zoomy  + (GameStaticImage.s_share_ui_button_01[0].bitmap.getHeight()/2 - GameStaticImage.s_share_ui_button_01[1].bitmap.getHeight()/2)), (int)(134 * GameConfig.f_zoomx * 1.2f), -1);
					} else {				
						GameStaticImage.s_share_ui_button_01[0].drawBitmap(canvas, null, (int)(Location.GameShop.shopUpGradebutton_xy[i][0] * GameConfig.f_zoomx), (int)(Location.GameShop.shopUpGradebutton_xy[i][1] * GameConfig.f_zoomy), (int)(134 * GameConfig.f_zoomx), -1);
					}
...
//					mySprite.drawBitmap(canvas, shop[i]+".png", Location.GameShop.shopitem_xy[i][0] * GameConfig.f_zoomx, Location.GameShop.shopitem_xy[i][1] * GameConfig.f_zoomy, null);
					shopIcon[i].drawBitmap(canvas, shopIcon[i].bitmap, Location.GameShop.shopitem_xy[i][0] * GameConfig.f_zoomx, Location.GameShop.shopitem_xy[i][1] * GameConfig.f_zoomy, null);
		...
		//			} else {
				...
				if(shop_index == 0){
					...
					float tempx = Location.GameShop.shopitemUp_priceicon_xy[i][0] * GameConfig.f_zoomx;
					float tempy = Location.GameShop.shopitemUp_priceicon_xy[i][1] * GameConfig.f_zoomy;
					if (shopUpbox[i]) {
						//shopitem_priceicon[1].drawBitmap(canvas, shopitem_priceicon[1].bitmap, Location.GameShop.shopitem_priceicon_xy[i][0] * GameConfig.f_zoom, Location.GameShop.shopitem_priceicon_xy[i][1] * GameConfig.f_zoom, null);
						shopitem_priceicon[1].drawBitmap(canvas, tempx - (anjianbutton[i]?0.2f:0f) * shopitem_priceicon[1].bitmap.getWidth()/2, tempy - (anjianbutton[i]?0.2f:0f) * shopitem_priceicon[1].bitmap.getHeight()/2, anjianbutton[i]?1.2f:1.0f, anjianbutton[i]?1.2f:1.0f, 255, 0, 0, 0);
					} else {
...
//			load1.drawBitmap(canvas, load1.bitmap, GameConfig.GameScreen_Width/2 - load1.bitmap.getWidth()/2, GameConfig.GameScreen_Height/2 + load1.bitmap.getHeight()/2, null);
	...
	private void paintShopItemWord(Canvas canvas) {
		if(shop_index == 0){
			...
			for (int i=0;i<shopitemword.length; i++) {
				canvas.save();
				canvas.clipRect(Location.GameShop.shopitemUp_word_xy[i][0] * GameConfig.f_zoomx, Location.GameShop.shopitemUp_word_xy[i][1] * GameConfig.f_zoomy, (Location.GameShop.shopitemUp_word_xy[i][0] + 153) * GameConfig.f_zoomx, (Location.GameShop.shopitemUp_word_xy[i][1] + 45) * GameConfig.f_zoomy);
				shopitemword[i].paintText(canvas, (int)(Location.GameShop.shopitemUp_word_xy[i][0] * GameConfig.f_zoomx), (int)(Location.GameShop.shopitemUp_word_xy[i][1] * GameConfig.f_zoomy) + word_move_y[i]);
				canvas.restore();			
			}
		}
	}
	...
	private void upgrade_quality(){
		if(prop_upgrade != -1){
			...
			if (shopUpbox[prop_upgrade]) { //true为金币 false位砖石、
				...
				if(shop_index == 1){
					for (int i=0; i<anjianbutton.length; i++) {
						if (ExternalMethods.CollisionTest(x, y, 
								(int)(Location.GameShop.shopUpGradebutton_xy[i][0] * GameConfig.f_zoomx + (GameStaticImage.s_share_ui_button_01[0].bitmap.getWidth()/2 - GameStaticImage.s_share_ui_button_01[1].bitmap.getWidth()/2)), 
								(int)(Location.GameShop.shopUpGradebutton_xy[i][1] * GameConfig.f_zoomy + (GameStaticImage.s_share_ui_button_01[0].bitmap.getHeight()/2 - GameStaticImage.s_share_ui_button_01[1].bitmap.getHeight()/2)), 
								(int)(Location.GameShop.shopUpGradebutton_xy[i][0] * GameConfig.f_zoomx + (GameStaticImage.s_share_ui_button_01[0].bitmap.getWidth()/2 - GameStaticImage.s_share_ui_button_01[1].bitmap.getWidth()/2) + 134 * GameConfig.f_zoomx * 1.2f), 
								(int)(Location.GameShop.shopUpGradebutton_xy[i][1] * GameConfig.f_zoomy + (GameStaticImage.s_share_ui_button_01[0].bitmap.getHeight()/2 - GameStaticImage.s_share_ui_button_01[1].bitmap.getHeight()/2) + GameStaticImage.s_share_ui_button_01[1].bitmap.getHeight()))) {
...
//						
				...
				for (int i=0; i<anjianbutton.length; i++) {
					if (ExternalMethods.CollisionTest(x, y, 
							...
							(int)(Location.GameShop.shopUpGradebutton_xy[i][1] * GameConfig.f_zoomy + (GameStaticImage.s_share_ui_button_01[0].bitmap.getHeight()/2 - GameStaticImage.s_share_ui_button_01[1].bitmap.getHeight()/2) + GameStaticImage.s_share_ui_button_01[1].bitmap.getHeight()))) {
						boolean co = false;
						if(shopitem_price.length>i){ //upgrade 
				...
				if (ExternalMethods.CollisionTest(x, y, 
						...
						if(i == 0){
							...
							for (int j=0; j<shopitemword.length; j++) {
								...
								shopitemword[j].setTextSize((int)(30*GameConfig.f_zoom));
