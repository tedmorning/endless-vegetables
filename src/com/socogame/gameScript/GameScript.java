...
public class GameScript {
	...
	public static final byte Banana = 18;//是否有香蕉皮new short[]{Banana, x, y}
	public static final byte Cobweb = 19;//是否有蜘蛛网new short[]{Banana, x, y}
	public static final byte Rose = 20;//是否有蔷薇道具new short[]{Rose, x, y}
	public static final byte MagicDoor = 21;//是否有魔法门道具new short[]{MagicDoor, x, y, 多少时间后出现， 出现多少时间}
...
//				
////				new short[]{Banana,266,300},
//				
////				new short[]{Cobweb,266,500},
//				
////				new short[]{Rose,266,500},
//				
//				new short[]{MagicDoor, 266, 250, 50, 2000},
//				
//			},						
//		};
//	};
...
//			},
	...
	private short[][][] script_5()//解锁洋葱
	{
		...
		new short[][][]
		{
			...
			new short[][]{	//	教学1：第一次使用道具			
				new short[]{EnterTeach, GameTeaching.TEACH_VOL12},//判断教学是否已经执行过	
				new short[]{ClothTouch},//关闭触摸					
				new short[]{Refresh,CoolEditDefine.Enemy_SHMM,350,1,266},//小蓝怪
				new short[]{Wait,10},
				new short[]{Refresh,CoolEditDefine.Enemy_SHMM,300,2,266-66,266+66},//小蓝怪
				new short[]{Wait,10},
				new short[]{OpenTouch},//打开触摸
				new short[]{TeachState, GameTeaching.TEACH_VOL12},				
			},
			
			new short[][]{	//	教学1：第一次使用乱舞	
				new short[]{EnterTeach, GameTeaching.TEACH_VOL14},//判断教学是否已经执行过	
				new short[]{ClothTouch},//关闭触摸	
				new short[]{Refresh,CoolEditDefine.Enemy_SHMM,250,5,134,200,266,332,398},//小蓝怪
				
				new short[]{Refresh,CoolEditDefine.Enemy_SHMM,300,1,266},//小蓝怪
				
				new short[]{Refresh,CoolEditDefine.Enemy_SHMM,300,2,266-66,266+66},//小蓝怪
				
				new short[]{Refresh,CoolEditDefine.Enemy_SHMM,350,1,266},
				new short[]{Wait,10},
				new short[]{OpenTouch},//打开触摸
				new short[]{TeachState, GameTeaching.TEACH_VOL14},				
			},
		...
		return
				...
				new short[][]{	//	第1波
					...
					new short[][]{	//	第4波
						...
						new short[]{Wait,100},
						////{DENGJI,2},
						new short[]{Refresh,CoolEditDefine.Enemy_SHMM,150,5,26,146,266,346,506},
					},
				};
	};
	private short[][][] script_7()
	{
		...
		new short[][][]
		{
			...
			new short[][]{	//	教学1：第一次使用援助	
				new short[]{EnterTeach, GameTeaching.TEACH_VOL19},//判断教学是否已经执行过	
				new short[]{ClothTouch},//关闭触摸					
				new short[]{Refresh,CoolEditDefine.Enemy_SHMM,150,1,266},//小蓝怪
				new short[]{Wait,10},
				new short[]{Refresh,CoolEditDefine.Enemy_SHMM,150,2,266-66,266+66},//小蓝怪
				new short[]{Wait,10},
				new short[]{OpenTouch},//打开触摸
				new short[]{TeachState, GameTeaching.TEACH_VOL19},				
			},	
	...
	private short[][][] script_26()
	{
		return
				...
				new short[][]{	//	第1波
					...
					new short[][]{	//	第2波(Refresh，种类，Y,数量，X1,X2....)
						////{DENGJI,26},
						new short[]{Refresh,CoolEditDefine.Enemy_SIREN,300,1,206},
						new short[]{Wait,40},
						new short[]{Refresh,CoolEditDefine.Enemy_SHZ,300,1,266},//箭头形
						new short[]{Refresh,CoolEditDefine.Enemy_SHZ,225,2,206,326},
...
//						////{DENGJI,26},
					...
					new short[][]{	//	第3波
						////{DENGJI,26},
						new short[]{Refresh,CoolEditDefine.Enemy_SIREN,300,1,266},
						new short[]{Wait,40},
						new short[]{Refresh,CoolEditDefine.Enemy_SHX,300,1,266},
	...
	private short[][][] script_28()//任务关3 命中率为100%
	{
		return
				...
				new short[][]{	//	第1波
					...
					new short[][]{	//	第2波
						new short[]{Refresh,CoolEditDefine.Enemy_SIREN,300,1,400},
						new short[]{Wait,40},
						new short[]{Refresh,CoolEditDefine.Enemy_SHHT,150,3,146,266,386},
						new short[]{Wait,80},
						new short[]{Refresh,CoolEditDefine.Enemy_SHHT,190,2,146,266},
...
//						////{DENGJI,2},
	...
	private short[][][] script_30()//BOSS 章鱼
	{
		return
				...
				new short[][]{ 
				        ...
				        new short[]{Wait,40},
						new short[]{Refresh,CoolEditDefine.Enemy_SIREN,300,1,30},
				   }
				};
	};
	...
	private short[][][] script_33()//22
	{
		...
		new short[][][]
		{
				new short[][]{	//	第1波
						new short[]{OpenFight2Music},
				new short[]{Board, 306,390,406,420},
	...
	private short[][][] script_34()//26
	{
		return
				...
				new short[][]{	//	第1波
						new short[]{OpenFight2Music},
						new short[]{Board,406,400,126,360},
	...
	private short[][][] script_35()//墨汁关,解锁洋葱
	{
		return
				...
				new short[][]{	//	第1波
						new short[]{OpenFight2Music},
						new short[]{Board, 286,400,226,340,366,340},
	...
	private short[][][] script_40()
	{
		return
				...
				new short[][]{	//	第1波
					...
					new short[][]{	//	第3波
						new short[]{Refresh1,CoolEditDefine.Enemy_DS,150,66,3,30},
						new short[]{Wait,90},
	...
	private short[][][] script_43()//任务关2
	{
		return
				...
				new short[][]{	//	第1波
						new short[]{OpenFight2Music},
						new short[]{Board, 266,400,206,400,326,400},
						new short[]{Refresh,CoolEditDefine.Enemy_MEGICWATER,330,1,206},
						new short[]{Wait,40},
	...
	private short[][][] script_44()//猪，熊，小兰怪
	{
		return
				...
				new short[][]{	//	第1波
						new short[]{OpenFight2Music},
						new short[]{Board, 206,300,266,400,326,450},
	...
	private short[][][] script_46()
	{
		return
				...
				new short[][]{	//	第1波
						new short[]{OpenFight2Music},
						new short[]{Board, 266,360,326,426},
